...
public class AutoSaverEditor : EditorWindow
{
  ...
  private void OnGUI()
  {
    ...
    #endregion AutoSaver Debug button
    ...
    #endregion Assets saver and Save on play buttons
    ...
    #endregion Save and Delete buttons
  }
